...
if (global.gameover) {
	...
	if (isDead) {
		draw_set_halign (fa_center);
		draw_text(512, 280, "Really? I thought you're better than this.");
	}
	else if (objCount == 0) {
		draw_set_halign(fa_center);
		draw_text(512, 220, "Touch the yellow ball to start");
		draw_text(512, 280, "Press <R> at any time to retry");
	}
}
